<h2><a href="https://www.geeksforgeeks.org/problems/count-product-categories/1?page=2&category=python&status=unsolved&sortBy=submissions">Count Product Categories</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><h2>Problem Description:</h2>
...
<h3>Explanation:</h3>
<p><span style="font-size: 14pt;">The result is a <strong>DataFrame </strong>having <strong>category_name </strong>and <strong>product_count</strong>.</span></p>
<ul>
<li>
...
<blockquote>
<pre><span style="font-size: 14pt;"><span style="font-size: 18.6667px;"><strong>Note:</strong> Please use the same variable names and format as shown in the output</span></span></pre>
