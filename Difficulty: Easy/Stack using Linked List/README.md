<h2><a href="https://www.geeksforgeeks.org/problems/implement-stack-using-linked-list/1?page=1&category=Arrays,Strings,Hash,Linked%20List&company=Amazon,Microsoft,Google,Flipkart,Adobe,NPCI,Samsung&difficulty=Easy,Medium&status=unsolved&sortBy=submissions">Stack using Linked List</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;"><span style="font-size: 18.6667px;">Implement a <strong>Stack </strong>using a Linked List. The stack has dynamic size and can grow until memory is available.</span><br><span style="font-size: 14pt;">The Stack must support the following operations:</span></span></p>
