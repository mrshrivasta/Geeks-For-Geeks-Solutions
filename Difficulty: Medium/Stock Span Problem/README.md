<h2><a href="https://www.geeksforgeeks.org/problems/stock-span-problem-1587115621/1?page=2&category=Arrays,Strings,Hash,Linked%20List&company=Amazon,Microsoft,Google,Flipkart,Adobe,NPCI,Samsung&difficulty=Easy,Medium&status=unsolved&sortBy=submissions">Stock Span Problem</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">The stock span problem is a financial problem where we have a series of daily price quotes for a stock and we need to calculate the span of stock price for all days.</span></p>
