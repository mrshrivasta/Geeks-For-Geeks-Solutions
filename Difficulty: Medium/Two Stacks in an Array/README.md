<h2><a href="https://www.geeksforgeeks.org/problems/implement-two-stacks-in-an-array/1?page=2&category=Arrays,Strings,Hash,Linked%20List&company=Amazon,Microsoft,Google,Flipkart,Adobe,NPCI,Samsung&difficulty=Easy,Medium&status=unsolved&sortBy=submissions">Two Stacks in an Array</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p data-start="218" data-end="334"><span style="font-size: 14pt;">Given an array of a fixed size. Efficiently implement <strong data-start="296" data-end="310">two stacks</strong> in this single array.</span></p>
...
<pre><span style="font-size: 18px;"><strong>Input: </strong>push1(2), push1(3), push2(4), pop1(), pop2() and pop2()
...
<pre><span style="font-size: 18px;"><strong>Input: </strong>push1(1), push2(2), </span><span style="font-size: 18px;">pop1(), push1(3), pop1() and pop1()
...
<pre><span style="font-size: 14pt;"><strong>Input: </strong>push1(2), push1(3), push1(4), pop2(), pop2() and pop2()
